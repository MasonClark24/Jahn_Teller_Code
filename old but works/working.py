from OptimizedFunctions import *
import matplotlib.pyplot as plt
from time import time


"""
goal right now is to use a filter function to remove things outside the gaussian
-- hmmmmm
"""
...
def full_matrix_madm_over_time(q, J_0, K, Q, S, elec1, elec2, Kt=Kt,
    ...
    # get relevant info, which holds the order of Js and Ks
    ...
    def madm(t):
        # get psi(t)
        psi_t, _ = psi_t_function(psi_0, psi_vector_parts, t, indices_of_good_eigenvalues)
